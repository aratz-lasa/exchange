defmodule Good do
  ...
  def to_record(%__MODULE__{id: i, name: n, price: p, description: d}),
    do: {__MODULE__, i, n, p, d}

  def to_struct({__MODULE__, i, n, p, d}),
    do: %__MODULE__{id: i, name: n, price: p, description: d}

  def to_struct([i, n, p, d]), do: %__MODULE__{id: i, name: n, price: p, description: d}

  def encode(%__MODULE__{id: i, name: n, price: p, description: d}),
    do: Enum.join([i, n, p, d], "#")
